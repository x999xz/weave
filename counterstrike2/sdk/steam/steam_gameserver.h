...
inline CSteamGameServerAPIContext& SteamGameServerInternal_ModuleContext()
{
	...
	// NOTE: declaring "CSteamAPIConext" creates a large function
	...
	// buffer of the appropriate size and call it a CSteamAPIContext.
	void* s_CallbackCounterAndContext[2 + sizeof( CSteamGameServerAPIContext ) / sizeof( void* )] = { (void*)&SteamGameServerInternal_OnContextInit, 0 };

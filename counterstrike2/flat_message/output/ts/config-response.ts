...
export class ConfigResponse implements flatbuffers.IUnpackableObject<ConfigResponseT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ConfigResponse {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsConfigResponse(bb:flatbuffers.ByteBuffer, obj?:ConfigResponse):ConfigResponse {
  return (obj || new ConfigResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsConfigResponse(bb:flatbuffers.ByteBuffer, obj?:ConfigResponse):ConfigResponse {
...
static startConfigResponse(builder:flatbuffers.Builder) {
...
static endConfigResponse(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createConfigResponse(builder:flatbuffers.Builder, nameOffset:flatbuffers.Offset, valueOffset:flatbuffers.Offset, shareOffset:flatbuffers.Offset, updated:bigint, created:bigint, userOffset:flatbuffers.Offset, ownerOffset:flatbuffers.Offset):flatbuffers.Offset {
  ConfigResponse.startConfigResponse(builder);
  ConfigResponse.addName(builder, nameOffset);
  ConfigResponse.addValue(builder, valueOffset);
  ConfigResponse.addShare(builder, shareOffset);
  ConfigResponse.addUpdated(builder, updated);
  ConfigResponse.addCreated(builder, created);
  ConfigResponse.addUser(builder, userOffset);
  ConfigResponse.addOwner(builder, ownerOffset);
  return ConfigResponse.endConfigResponse(builder);
}

unpack(): ConfigResponseT {
  return new ConfigResponseT(
    this.name(),
    this.value(),
    this.share(),
    this.updated(),
...
unpackTo(_o: ConfigResponseT): void {
  _o.name = this.name();
  _o.value = this.value();
  _o.share = this.share();
...
export class ConfigResponseT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return ConfigResponse.createConfigResponse(builder,
    name,
    value,
    share,
    this.updated,
